...
module.exports = class E27DecorativeDriver extends Homey.Driver {

  /**
   * onInit is called when the driver is initialized.
   */
  async onInit() {
    this.log('E27 Decorative driver has been initialized');
  }
          ...
          try {
            ...
            if (houseInfo && Array.isArray(houseInfo.deviceList)) {
              return houseInfo.deviceList
                .filter(device => device.deviceTypeCode === 44)
                .map(device => ({
